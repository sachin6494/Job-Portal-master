      ...
      <div id="page-in" class="box">
        ...
        <div id="homeContent">
          ...
          <div class="article">
            ...
            <h2><span><a href="#">Feedback List</a></span></h2>
            ...
            <table width="100%" border="1" bordercolor="#1CB5F1">
                            ...
                            $sql = "select FeedbackId,Feedback,FeedbakDate,JobSeekerName from feedback inner join jobseeker_reg where feedback.JobSeekId=jobseeker_reg.JobSeekId";
                            // Execute query
